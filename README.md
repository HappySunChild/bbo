...
```rs
use bbo::buffer::{WriteBytes, WriteBytesFloat, WriteBytesSigned};
...
> [!NOTE]
> This crate automatically implements methods for any objects that implement the `std::io::Read` and `std::io::Write` traits.